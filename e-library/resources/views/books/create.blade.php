        ...
        <form action="{{ route('books.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="number" id="tahun_terbit" name="tahun_terbit" min="1800" max="2099" required
                        class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
            ...
            <div class="mt-8 flex justify-end">
                <button type="button" onclick="window.location.href='{{ route('books.index') }}'"
                    class="px-4 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600 transition-colors mr-4">
                    Batal
                </button>
                <button type="submit"
