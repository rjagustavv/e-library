            ...
            <div class="flex flex-col w-64 bg-gray-800">
                ...
                <div class="flex flex-col flex-1 overflow-y-auto">
                    <nav class="flex-1 px-2 py-4 space-y-1">
                        <a href="{{ route('dashboard.index') }}" class="flex items-center px-4 py-2 text-sm font-medium text-gray-300 {{ request()->routeIs('dashboard') ? 'text-white bg-gray-700' : 'hover:bg-gray-700 hover:text-white'}}  rounded-md">
